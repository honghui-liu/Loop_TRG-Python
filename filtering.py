...
def get_one_projector(Left_fixed_point, Right_fixed_point):
    ...
    # delete sigular values that are smaller than 1.e-12
    length = len(s)
    j = 0
...
def filter(Tensor_A,Tensor_B):
    ...
    All_left_projector[0], All_right_projector[3] = get_one_projector(All_left_fixed_point[0],All_right_fixed_point[3])
    All_left_projector[1], All_right_projector[0] = get_one_projector(All_left_fixed_point[1],All_right_fixed_point[0])
    All_left_projector[2], All_right_projector[1] = get_one_projector(All_left_fixed_point[2],All_right_fixed_point[1])
    All_left_projector[3], All_right_projector[2] = get_one_projector(All_left_fixed_point[3],All_right_fixed_point[2])
